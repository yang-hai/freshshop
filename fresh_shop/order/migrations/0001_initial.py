# Generated by Django 2.1.5 on 2019-01-14 02:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('WAIT_BUYER_PAY', '交易创建'), ('paying', '待支付'), ('TRADE_SUCCESS', '成功'), ('TRADE_CLOSE', '交易关闭'), ('TRADE_FINISHED', '交易结束')], default='paying', max_length=20, verbose_name='交易状态')),
